...
namespace OpenForge.Server.PacketStructures.World
{
    ...
    public class CNetGetRankingPvP1vs1ByRangeRMR
    {
        ...
        public CNetGetRankingPvP1vs1ByRangeRMR(bool defaultHeader)
        {
            Header = new CNetDataHeader(InterfaceType.World, (int)WorldMessageType.CNetGetRankingPvP1vs1ByRangeRMR, true);
            Status = default(int);
