...
namespace OpenForge.Server.PacketStructures.World
{
    ...
    public class CNetGetRankingPvP2vs2ByRangeRMR
    {
        ...
        public CNetGetRankingPvP2vs2ByRangeRMR(bool defaultHeader)
        {
            Header = new CNetDataHeader(InterfaceType.World, (int)WorldMessageType.CNetGetRankingPvP2vs2ByRangeRMR, true);
            Status = default(int);
