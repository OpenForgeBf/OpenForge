...
namespace OpenForge.Server.PacketStructures.World
{
    ...
    public class CNetAcceptDirectTradeRMR
    {
        ...
        public CNetAcceptDirectTradeRMR(bool defaultHeader)
        {
            Header = new CNetDataHeader(InterfaceType.World, (int)WorldMessageType.CNetAcceptDirectTradeRMR, true);
            Status = default(int);
