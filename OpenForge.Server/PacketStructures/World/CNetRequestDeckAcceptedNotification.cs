...
namespace OpenForge.Server.PacketStructures.World
{
    ...
    public class CNetRequestDeckAcceptedNotification
    {
        ...
        public CNetRequestDeckAcceptedNotification(bool defaultHeader)
        {
            Header = new CNetDataHeader(InterfaceType.World, (int)WorldMessageType.CNetRequestDeckAcceptedNotification, false);
