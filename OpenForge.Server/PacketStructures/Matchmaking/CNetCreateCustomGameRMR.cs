...
namespace OpenForge.Server.PacketStructures.Matchmaking
{
    ...
    public class CNetCreateCustomGameRMR
    {
        ...
        public CNetCreateCustomGameRMR(bool defaultHeader)
        {
            Header = new CNetDataHeader(InterfaceType.Matchmaking, (int)MatchmakingMessageType.CNetCreateCustomGameRMR, true);
            Status = default(int);
